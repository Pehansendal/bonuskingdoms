...
var N = /* @__PURE__ */ __name((t, s) => () => (t && (s = t(t = 0)), s), "N");
var A = /* @__PURE__ */ __name((t, s) => () => (s || t((s = { exports: {} }).exports, s), s.exports), "A");
var nt = /* @__PURE__ */ __name((t, s, i, e) => {
  if (s && typeof s == "object" || typeof s == "function")
    for (let a of ct(s))
      !ot.call(t, a) && a !== i && L(t, a, { get: () => s[a], enumerable: !(e = it(s, a)) || e.enumerable });
  return t;
}, "nt");
var O = /* @__PURE__ */ __name((t, s, i) => (i = t != null ? et(at(t)) : {}, nt(s || !t || !t.__esModule ? L(i, "default", { value: t, enumerable: true }) : i, t)), "O");
var h;
var r = N(() => {
  h = { collectedLocales: [] };
});
...
async function K(t) {
  ...
  try {
    ...
    switch (t.method) {
      case "GET": {
        let o = W(t, gt), c = await e.get(a, { softTags: o });
      ...
      case "POST": {
        let o = globalThis[ht], c = /* @__PURE__ */ __name(async () => {
          let n = await t.json();
          n.data.tags === void 0 && (n.tags ??= W(t, bt) ?? []), await e.set(a, n);
        }, "c");
...
function ut() {
  ...
  globalThis.fetch = async (...s) => {
    ...
    return e || (e = await K(i), e) ? e : (dt(i), t(i));
  };
}
__name(ut, "ut");
async function mt(t) {
...
var T = /* @__PURE__ */ __name(class {
  ...
  applyLocaleRedirects(s) {
    if (!s.locale?.redirect || !/^\^(.)*$/.test(s.src) && s.src !== this.path || this.headers.normal.has("location"))
      return;
    let { locale: { redirect: e, cookie: a } } = s, o = a && this.cookies[a], c = q(o ?? ""), n = q(this.reqCtx.request.headers.get("accept-language") ?? ""), l = [...c, ...n].map((x) => e[x]).filter(Boolean)[0];
    if (l) {
  ...
  async checkPhase(s) {
    ...
    let a = "miss";
    return e || s === "miss" || s === "error" ? a = "hit" : i && (a = I(s)), this.checkPhase(a);
  }
  async run(s = "none") {
...
var ge = { async fetch(t, s, i) {
  ...
  return a.run({ ...s, NODE_ENV: "production", SUSPENSE_CACHE_URL: f }, async () => o.run({ env: s, ctx: i, cf: t.cf }, async () => {
    ...
    let n = F(t);
    return Q({ request: n, ctx: i, assetsFetcher: s.ASSETS }, b, g, h);
  }));
} };
export {
  ge as default
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.1286296353969243.mjs.map
